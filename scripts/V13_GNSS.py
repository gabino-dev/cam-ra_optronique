...
class NMEAReader(QThread):
    nmea_update = Signal(str, str, float)  # latitude, longitude, heading
        ...
        while self.running:
            try:
                ...
                try:
                    ...
                    # $GPRMC contient la position et le cap vrai (true heading)
...
class CameraInterface(QWidget):
    def __init__(self):
        ...
        # === Bloc GPS NMEA ===
        gps_group = QGroupBox("Position bateau (NMEA)")
