...
# def send_fov_can(value):
#     """Envoie une trame CAN 0x101 avec Field paramétré, les autres champs à 0."""
#     if not (0 <= value <= 5000):
#         print("FOV CAN value hors plage.")
#         return
#
#     field = int(value) & 0xFFFF
#     field_lsb = field & 0xFF
#     field_msb = (field >> 8) & 0xFF
#
#     # Byte 0 = caméra/AGC/AGCwin = 0
#     byte0 = 0x00
#     byte3 = 0x00  # Merge
#     byte4 = 0x00  # Gain
#     byte5 = 0x00  # Level
#
#     # Construction trame hexadécimale complète
#     can_data = f"{byte0:02X}{field_lsb:02X}{field_msb:02X}{byte3:02X}{byte4:02X}{byte5:02X}"
#     cmd = f"cansend can0 101#{can_data}"
#
#     print(f"Envoi FOV : {cmd}")
#     ret = subprocess.call(cmd, shell=True)
#     if ret != 0:
#         print(f"Erreur d'envoi CAN FOV (code {ret})")
